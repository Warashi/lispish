	...
	tests := []struct {
	...
	}{
		{
			...
			expected: []Token{
				...
				{Type: Identifier, Literal: "square", Line: 1, Column: 9},
				{Type: Identifier, Literal: "x", Line: 1, Column: 16},
				{Type: Delimiter, Literal: ")", Line: 1, Column: 17},
				{Type: Delimiter, Literal: "(", Line: 1, Column: 19},
				{Type: Identifier, Literal: "*", Line: 1, Column: 20},
				{Type: Identifier, Literal: "x", Line: 1, Column: 22},
				{Type: Identifier, Literal: "x", Line: 1, Column: 24},
				{Type: Delimiter, Literal: ")", Line: 1, Column: 25},
